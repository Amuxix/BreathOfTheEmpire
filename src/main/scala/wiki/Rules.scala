...
object Rules:
  ...
  private def rulesFromPattern(entries: (String, String) | (String, String, Category & Text)*): List[Rule] =
    entries.toList.map {
      case (pattern, page)           => PageRule(insensitiveWord(pattern), page)
      case (pattern, page, category) => CategoryRule(insensitiveWord(pattern), page, category)
    }

  private def sensitiveButNotAfterComma(term: String): Regex =
    s"(?<!\\. ?)\\b$term\\b".r

  private def rulesFromSensitivePattern(entries: (String, String) | (String, String, Category & Text)*): List[Rule] =
    entries.toList.map {
      case (pattern, page)           => PageRule(sensitiveButNotAfterComma(pattern), page)
      case (pattern, page, category) => CategoryRule(sensitiveButNotAfterComma(pattern), page, category)
    }
  ...
  private def rulesFromName(entries: String | (String, Category & Text)*): List[Rule] =
    entries.toList.map {
      case name: String     => PageRule(quoted(name), name)
      case (name, category) => CategoryRule(quoted(name), name, category)
    }

  // format: off
  private val eternals = rulesFromSensitivePattern(
    // Spring
    ("(Arhallogen|Spider King|Scorpion Queen|Centipede General|Shadow-Hunter|Sharp Fangs|Maw-of-Spikes|Envenomed " +
      "Blade|Gasping Breath|Web of Blades|Many Move as One|Skittering Dark|Wicked Fangs)", "Arhallogen", Category
      .Arhallogen),
    ("(Irra Harah|Prince with a Thousand Foes|Papa Otec|Guard of the Young|Thorn of the Ancestors|Shackle " +
      "Smasher|[Tt]he Golden Hare|il Odioso|Hateful One)", "Irra Harah", Category.IrraHarah),
    ("(Llofir|[Tt]he Rotlord|Lady of Spores|[Tt]he Quiet One|[Tt]he Great Fungus|Wisdom of Dead Wood|End of " +
      "Empires|Inevitable Circle|[Tt]he Ruin|Blood Choke)", "Llofir", Category.Llofir),
    ("(Ossegrahn|Lord Rain|Coomarta of the Rains|Cupbearer|Brother Harvest|Bogfearthan|Father Tarn|Llomon|Elder " +
      "Fossegrim|Willowbraid|Beckburn|Greenfount)", "Ossegrahn", Category.Ossegrahn),
    ("(Siakha|Maelstrom|Empress of Sharks|Schiuma Sanguinosa|Salt-born Devourer|Thunder-that-Speaks|Mother of " +
      "Wrecks|Red Squid|Maw of Stone)", "Siakha", Category.Siakha),
    ("(Yaw'nagrah|Queen of the Forest|Green Mother|Rootwinder|Old Bloodbark|Verdant Queen|Lady of the Woods|Lady of " +
      "Bark and Bramble|One who Sways and Stands|Thorncreeper|Treecaller|Woodwyf|Cornwalker|Midwife|Wheatweaver|Green" +
      " Hand|Nest of Thorns|[Tt]he Plentiful|Mother of Briars|Barkspawner)", "Yaw'nagrah", Category.`Yaw'nagrah`),
    // Summer
    ("(Adamant|King Adamant|King Under the Mountain|Sharaz|Throne of Adamant|Stone Dragon|Imperishable " +
      "Potentate|Master of the Endless Delve|Throne of Stone|Deep Dragon|Wallshaper|Liege Unbreakable|Keeper of the " +
      "Impenetrable Vault)", "Adamant", Category.Adamant),
    ("(Barien|Iron Duke|Seneschal of the Road|Lord of the Crossroads|Knight of the Long Road|Host of Hosts|[Tt]he " +
      "Traveller|Master of Challenges|Keeper of the Revels|Reeve of the Summer Lands|Barien " +
      "Dragonforge|Iron-Staff|Lord of the Arena)", "Barien", Category.Barien),
    ("(Cathan Canae|Queen of Ice and Darkness|Lady of the Frost|Breath of Winter|Mistress of Blizzards|Immovable One)" +
      "", "Cathan Canae", Category.CathanCanae),
    ("(Eleonaris|Queen of the Fields of Glory|Lady of Pennants|Commander of the Golden Armies|Sovereign in Scarlet " +
      "and Gold|Lion of Summer|Sun Drake)", "Eleonaris", Category.Eleonaris),
    ("(Hayaak|Gryphon-King|Prince-in-Exile|Brother of Lions|Hawk Lord|Blood Eagle)", "Hayaak", Category.Hayaak),
    ("(Jaheris|Unicorn King|Unicorn Prince|Lord of the Forest of Arden|Moonsilver King|Silverbrow|Shadowed King|Lord " +
      "of Despite|Regent of the Spiderlands|Magister of the Argent Tower|Moonbow|Cunning Wolf)", "Jaheris", Category
      .Jaheris),
    ("(Meraud|Summer Enchanter|Golden Magician|Lord of Summer Stars|Fire Mage|Lord of the Lake)", "Meraud", Category
      .Meraud),
    ("(Rhianos|King Rhianos|Queen Rhianos|Regent of the Eternal Sea|Foamfollower|Bottlenose|(Lord|Lady) Gullscry|Lady" +
      " Gullscry|Hornsounder|Wind-at-the-Back|Homebreaker|Pathtwister|Deathpiper|Furole|Quicksilver|Glimmerbreeze" +
      "|Corposant|Dancing Merlin|Azure Songbird|Bright Zephyr|Booming Avalanche|Endless Voyage|Diving Falcon|Treasure" +
      " Giver|Golden Shatterspray|Lightning Fish|Leaping Salmon|Roaring Wavefather|Mother of the Wildest|[Tt]he " +
      "Waverider|Tiger's Eye|Shimmergold|Stormchaser|Sail Runner|Second Strike|Coruscating Oarfish|[Tt]he " +
      "Seadragon|Windweaver|Spume Sailor|Tide Dancer|Ocean Caller|Leaf-on-the-Breeze|Auspicious Mariner|Laird of the " +
      "Golden Tides|Sailor on the Sunlit Sea|Lord of the Argent Rime|King of the Nine Tides|Lady of the Far " +
      "Horizon|Master of the Far Shore|Lord of the Rolling Waves)", "Rhianos", Category.Rhianos),
    // Autumn
    ("(Basileia|Basileia Brazen|[Tt]he Brazen|Princess of Weirs|Carver of Cliques|Crown of the Archway|Mistress of " +
      "Falls|Patron of Spies and Traitors|Princess of the Black Vaults)", "Basileia", Category.Basileia),
    ("(Callidus|Prince of the Argent Tontine|Sovereign-Lord of the City of Chains|Golden Bargainer|Keeper of the " +
      "Gilded Chains|Satrapy of Hunger|Drooling Maw)", "Callidus", Category.Callidus),
    ("(Ephisis|Hidden Prince|[Tt]he Accounter|High Merchant|Lady of the Counting House|Sovereign Lady of the City of " +
      "Gold and Lead|Prince of Scales|Invisible Hand|Merchant Queen|Grand Plutocrat)", "Ephisis", Category.Ephisis),
    ("(Estavus|[Tt]he Forgemistress|Sovereign Lord of the City of Fire and Stone|Prince of Shikal|Bronze " +
      "Artisan|Towers of Calx and Coom|Hammer of Fire and Stone)", "Estavus", Category.Estavus),
    ("(Mazen|Mazen of the Many Faces|Lord of the Masks|Price of Folly|Unseen Hand|Gull-Catcher)", "Mazen", Category
      .Mazen),
    ("(Prospero|Golden Prince|Weaver|Lord of the Loom|Sovereign Lord of the City of Bridges|Prince of Ties|Reckoner " +
      "of Ebony and Bone|Golden Spider|Threadweaver|Cloven-hoofed|Polymitarius|el tejedor|Jemný Pavouk|Skredderen)",
      "Prospero", Category.Prospero),
    ("(Sinokenon|Apex Hyperion|Friend Of All|Silver Sovereign|Singular Point|That Which Lies Above All|Way of " +
      "Hierarchy|Diamondmind|That Which Lives In Its Name|Argent Mantra|Turning Mirror|Tomorrow And Tomorrow|Wheel Of" +
      " Light)", "Sinokenon", Category.Sinokenon),
    ("(Lictors|[Tt]he Punishers|[Tt]he Hunters|Sovereign Lords of the City of Bar and Bond|Chainbound|[Tt]he " +
      "Binders|Brass Magistrates|[Tt]he Furious Ones|Reckoners)", "Lictors", Category.Lictors),
    // Winter
    ("(Agramant|[Tt]he Howler|[Tt]he Hunter|Wendigo|Devourer of the Fallen|Voice of the Pines|Blood-on-the-Snow|Dream" +
      " of Famine|[Tt]he Whisperer|[Tt]he Wastewalker|[Tt]he Abominable One|Horned Manticore|Harvester of Graves|Old " +
      "Bloody Teeth|Scrandaddy)", "Agramant", Category.Agramant),
    ("(Kaela|Lady of the Grim Host|Sorrowful One|End-of-Strength|Lady of " +
      "Oblivion|Cold-Hearted|Dark-Between-The-Stars|Queen of Silence|[Tt]he Black Dog|Queen Esk|la Reine qui siège " +
      "sur le Trône Noir)", "Kaela", Category.Kaela),
    ("(Sorin|Hungry Wolf|Tomb King|Empty One|Devourer-of-Hope|Hunger-Crow|Father of Draughir|Master of Whelps)",
      "Sorin", Category.Sorin),
    ("(Thrice-cursed Court|[Tt]he Bound|[Tt]he Three)", "The Thrice-cursed Court", Category.ThriceCursedCourt),
    ("(Tharim|[Tt]he Bound King|Stoneheart)", "Tharim", Category.Tharim),
    ("(Skathe|Hag Queen)", "Skathe", Category.Skathe),
    ("(Surut|Charred Prince|Ashen Knight|Burnt Steward)", "Surut", Category.Surut),
    ("(Wise Rangara|[Tt]he Wise|[Tt]he Ancient One|[Tt]he Eldest|Grandmother Winter|Kind Rangara|Pale Raven|Clever " +
      "Spider|White Eye Serpent|[Tt]he Cruel Lady|[Tt]he Crone)", "Wise Rangara", Category.WiseRangara),
    ("(Zakalwe|Master Strategist|General of Day|Weapon-wise|Hunter of Tides|Zakalwe Dieu de la " +
      "Guerre|Strategos|Manush|Brilliant Javelin)", "Zakalwe", Category.Zakalwe),
    // Day
    ("(Cold Sun)", "Cold Sun", Category.ColdSun),
    ("(Kimus|Unblinking Eye|Celestial Eye|She Who Watches|Thousand Eyes of the Sun and Moon|Glass of the Heavens|Seer" +
      " Clad in Veils of Light|del sátrapa de la aurora|High Mandarin|First Minister|Grand Vizier)", "Kimus",
      Category.Kimus),
    ("(Leviathan|[Tt]he Deepest One|[Tt]he Foundation|Dweller in the Depths|Abyssal Lord|Fish of Why?|Watcher Beneath" +
      " the Waters|She-Who-Counts-The-Ripples|Unspeakable One Who Lies Beneath The Eternal Ocean)", "Leviathan",
      Category.Leviathan),
    ("(Phaleron|[Tt]he Great Library|Vault of Phaleron|Archives of Silence|Coral Library|Celestial Library)",
      "Phaleron", Category.Phaleron),
    ("(Roshanwe|[Tt]he Navigator|Walker on the Littoral|[Tt]he Mariner|[Tt]he Beacon|Elder Pharos|[Tt]he " +
      "Fisherman|Weaver of Nets|[Tt]he Beachcomber)", "Roshanwe", Category.Roshanwe),
    ("(Sung|Rainbow Serpent|Whispering Wind|Night Singer|Feather on the Breeze|Lady of Mysteries|Lord of " +
      "Illusions|Spiral Dancer|Everflowing River|Neznámy Otázka|one who hides the truth under its wings|Moon Moth)",
      "Sung", Category.Sung),
    ("(Ylenwe|Dove|Dove of the Perfect Morning|[Tt]he Morningstar|Pathway to Serenity|Nested Interval|Morning " +
      "Glory|Epsilon Close|Childe of Gentleness|Cradlesong|Silk Mask)", "Ylenwe", Category.Ylenwe),
    // Night
    ("(Azoth|[Tt]he Crucible|[Tt]he Rebis|[Tt]he Great Work)", "Azoth", Category.Azoth),
    ("(Janon|Shadowed Fire|Muse of Fire|Firebrand|Torchbearer|Night Sword)", "Janon", Category.Janon),
    ("(Lashonar|Gibbering Lashonar|Lashonar the Loquacious|Guardian of the Southern Skies|Keeper of the Gates of " +
      "Wisdom|Eater-of-Silence|Speaker in Dreams|Conscience-of-Kings)", "Lashonar", Category.Lashonar),
    ("(Sadogua|Brother of Wizards|Toad King|Wyrm-King|Father of Bats|[Tt]he Glutton|[Tt]he Lazy|Black Sloth|Shuttered" +
      " Lantern|Eater of Secrets|Globberslotch|Oracle Pig|Forfører|o Patrício astuto|Wujek Sadogua|Spell Glutton)",
      "Sadogua", Category.Sadogua),
    ("(Soghter|Changer of the Ways|[Tt]he Intrepid Dragon of Infallible Reason|Oroborous|Snake-Spawner|Mother of " +
      "Serpents|Father of Serpents|Azoth)", "Soghter", Category.Soghter),
  )

  private val nations = rulesFromName(
    "Imperial Orcs" -> Category.ImperialOrcs,
  ) ++ rulesFromPattern(
    ("(Navarr|Navarri)", "Navarr", Category.Navarr),
    ("(Urizen|Urizeni)", "Urizen", Category.Urizen),
    ("(Varushka|Varushkan)", "Varushka", Category.Varushka),
    ("(Brass Coast|Freeborn)", "The Brass Coast", Category.BrassCoast),
    ("(Highguard|Highborn)", "Highguard", Category.Highguard),
    ("(Wintermark|Winterfolk)", "Wintermark", Category.Wintermark),
  ) ++ rulesFromSensitivePattern(
    ("(Dawn|[Dd]awnish)", "Dawn", Category.Dawn),
    ("(([Tt]he )?League|[Ll]eaguer|city-folk)", "The League", Category.League),
    ("(([Tt]he )?Marches|Marcher)", "The Marches", Category.Marches),
  )
  ...
  private val religion = rulesFromSensitivePattern(
  ...
  private val varushkanSovereigns = rulesFromPattern(
    ("(The )?(Charnel Lord|Lord of the Crows|Battlefed|Moundshroud|King Beneath the Hill|Branocbound|Irontooth|Boyar " +
      "of the Broken Barrow)", "Charnel Lord", Category.CharnelLord),
    ("(The )?(Night Below|Blackdamp|Waiting Dark|Grasping Dark|Thieving Dark|Fly-the-light|Shadow-in-shadows|Eyes in " +
      "the Night|Dark-Below-The-Mountain|Extinguished " +
      "Sun|Shadowcreeper|Watcher-in-the-Corner|Nights-haven|Black-heart|Abyssal Lady)", "Night Below", Category
      .NightBelow),
    ("Dho'uala|Spirit of Dark Water|Light-in-the-Depths|Netripper|Undertow|Queen of the " +
      "Drowned|She-Who-Keeps-What-She-Catches|Lady of the Semmerlak", "Dho'uala", Category.`Dho'uala`),
  )
