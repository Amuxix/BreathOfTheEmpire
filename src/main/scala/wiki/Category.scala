...
enum Category:
  ...
  case Jarm                extends Category with ExtraCategory with CustomName("Principalities of Jarm")
  ...
  case Sumaah              extends Category with ExtraCategory with CustomName("Sumaah Republic")
